  ...
  return (
    <form className="userform__ctn userform__ctn--register">
      <Field
        ...
        infoTip={
          <div>
            Votre pseudo doit contenir : <br />- au minimum 3 caractères
            <br />- au maximun 16 caractères
            <br />- et maximun 3 chiffres
          </div>
        }
      />
      <Field
        ...
        info={true}
        infoTip={
          <div>L'utilisateur doit avoir au moins 13ans pour s'inscrire.</div>
        }
      />
      <Field
        name="email"
