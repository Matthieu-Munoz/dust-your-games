...
function AddGames() {
  ...
  const { searchInput, searchGames, selectedGame } = useSelector(
  ...
  return (
    <div className="addgames">
      ...
      {!modalLoading && (
        <>
          <form
            className="addgames__input"
            onSubmit={handleSearchSubmit}
            onFocus={() => dispatch(selectSearchGame(null))}
          >
            <Field
              innerRef={inputRef}
              name="searchInput"
            ...
            />
            <IoIosBackspace
              className="addgames__input__back"
              onClick={() => dispatch(resetSearchGames())}
            />
          </form>
          {!selectedGame ? (
              ...
              <div className="addgames__pictures">
                {searchGames &&
                  searchGames.map((item) => (
                    <div
                      key={item.id}
                      className="addgames__pictures__game"
