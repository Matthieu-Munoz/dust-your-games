...
import Svg from "Assets/images/loader.svg?component";
    ...
    !(function (t, n) {
      ...
      function Ft(t, n, e) {
        ...
        if (Tt(n)) {
          ...
          if (n.end) return jt(n, n.end, e, t, r);
        } else {
          if (n.end)
            return e.start
              ? It(n, n.end, e.start, e, t, r)
              : jt(n, n.end, e, t, r);
          if (e.start) return jt(n, e.start, e, t, r);
        }
        return kt(n, e, t, r);
      }
      function Nt(t, n, e) {
                ...
                Object.keys(zt).forEach(function (t) {
                  if (void 0 !== u[t])
                    if ("object" !== e(zt[t])) {
                      ...
                      Object.keys(zt[t]).forEach(function (n) {
                        if (void 0 !== u[t][n]) {
                          var e = u[t][n],
                            r = zt[t][n];
        ...
        if (e && r) {
          ...
          if (i === r.t)
            switch (e.t) {
              ...
              case "g":
                if (e.r === r.r) {
                  var u = { t: i, s: Yt(t, e.s, r.s), r: e.r };
                  return (
                    e.gt &&
                      r.gt &&
                      (u.gt = (function (t, n, e) {
          ...
          if (("c" === e.t && "g" === r.t) || ("c" === r.t && "g" === e.t)) {
            ...
            return (a.s = "c" === e.t ? Yt(t, l, a.s) : Yt(t, a.s, l)), a;
          }
        }
        return T(t, e, r);
      }
            ...
            u(o, null, [
              {
                key: "build",
                value: function (t) {
                  var n = h(a(o), "build", this).call(this, t, Qt);
                  if (!n) return null;
                  n.el,
                    n.options,
                    (function (t, n, e) {
        ...
        animations: [
          {
            elements: {
              eJQsld49PX556: {
                transform: {
                  data: {
                    o: { x: 155.763672, y: 73.671875, type: "corner" },
                    t: { x: -155.763672, y: -73.671875 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 500, v: { x: 1, y: 1 } },
                      { t: 2000, v: { x: 1.5, y: 1.5 } },
                      {
                        t: 3000,
                        v: { x: 1.1666666666666667, y: 1.1666666666666667 },
                      },
                    ],
                  },
                },
                opacity: [
                  ...
                  { t: 1200, v: 0.77 },
                  { t: 2100, v: 0.42 },
                  { t: 3000, v: 0.9420000000000002 },
                ],
              },
              eJQsld49PX561: {
                transform: {
                  data: {
                    o: { x: 295.642578, y: 106.974609, type: "corner" },
                    t: { x: -295.642578, y: -106.974609 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 1500, v: { x: 1.5, y: 1.5 } },
                      { t: 3000, v: { x: 1, y: 1 } },
                    ],
                  },
                },
              ...
              eJQsld49PX566: {
                transform: {
                  data: {
                    o: { x: 253.384766, y: 253.521484, type: "corner" },
                    t: { x: -253.384766, y: -253.521484 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
              ...
              eJQsld49PX571: {
                transform: {
                  data: {
                    o: { x: 98.923828, y: 179.544922, type: "corner" },
                    t: { x: -98.923828, y: -179.544922 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
              ...
              eJQsld49PX576: {
                transform: {
                  data: {
                    o: { x: 121.976563, y: 272.03125, type: "corner" },
                    t: { x: -121.976563, y: -272.03125 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 400, v: { x: 1, y: 1 } },
                      { t: 1900, v: { x: 1.5, y: 1.5 } },
                      { t: 3000, v: { x: 1, y: 1 } },
                    ],
                  },
                },
              ...
              eJQsld49PX581: {
                transform: {
                  data: {
                    o: { x: 89.689453, y: 100.712891, type: "corner" },
                    t: { x: -89.689453, y: -100.712891 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
              ...
              eJQsld49PX586: {
                transform: {
                  data: {
                    o: { x: 65.248047, y: 139.46875, type: "corner" },
                    t: { x: -65.248047, y: -139.46875 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 700, v: { x: 1, y: 1 } },
                      { t: 2200, v: { x: 1.5, y: 1.5 } },
                      { t: 3000, v: { x: 1, y: 1 } },
                    ],
                  },
                },
              ...
              eJQsld49PX591: {
                transform: {
                  data: {
                    o: { x: 265.974609, y: 56.142578, type: "corner" },
                    t: { x: -265.974609, y: -56.142578 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
              ...
              eJQsld49PX596: {
                transform: {
                  data: {
                    o: { x: 306.265625, y: 242.796875, type: "corner" },
                    t: { x: -306.265625, y: -242.796875 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 200, v: { x: 1, y: 1 } },
                      { t: 1700, v: { x: 1.5, y: 1.5 } },
                      { t: 3000, v: { x: 1, y: 1 } },
                    ],
                  },
                },
              ...
              eJQsld49PX5101: {
                transform: {
                  data: {
                    o: { x: 235.177734, y: 301.439453, type: "corner" },
                    t: { x: -235.177734, y: -301.439453 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                ...
                opacity: [
                  ...
                  { t: 2400, v: 1 },
                  { t: 2600, v: 0.2 },
                  { t: 3000, v: 0.2, e: [0.42, 0, 0.58, 1] },
                ],
              },
              eJQsld49PX5106: {
                transform: {
                  data: {
                    o: { x: 225.763672, y: 96.291016, type: "corner" },
                    t: { x: -225.763672, y: -96.291016 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
              ...
              eJQsld49PX5111: {
                transform: {
                  data: {
                    o: { x: 75.951172, y: 301.359375, type: "corner" },
                    t: { x: -75.951172, y: -301.359375 },
                  },
                  keys: {
                    s: [
                      { t: 0, v: { x: 1, y: 1 } },
                      { t: 300, v: { x: 1, y: 1 } },
                      { t: 1800, v: { x: 1.5, y: 1.5 } },
            ...
            s: "MKDA1MzhiMzI3NDg1UDAgyNzFNODQ3OUw3ZjdBlQTMyNGE0MzQwNDA0RMDNjMzI3NDc5ODI3NATczODQ3OTdmVjdlMzMI0YTQxM2MzMjc5ODQN3NTgyVDcxODQ3OTdmUN2U4MzMyNGE0MDNjMDzI3Njc5N2M3YzMyNGCE0MTNjMzI3MTdjODQB3NTgyN2U3MTg0NzUzQMjRhNzY3MTdjODM3NITNjMzI4MzgwNzU3NTJc0MzJONGE0MVM4ZA|F",
          },
        ],
        options: "MDDAxMDg4RzJmODA4MTIZlN2Y4MTJmUjQ3MmYM3OTdjNmU3MTJmOGE/X",
      },
      "__SVGATOR_PLAYER__",
      window
    );
